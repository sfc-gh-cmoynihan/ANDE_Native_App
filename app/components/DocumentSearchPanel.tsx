...
import { Search, AlertCircle, Download, ChevronDown } from "lucide-react"
...
export function DocumentSearchPanel({ customerId, customerName, customerEmail }: DocumentSearchPanelProps) {
  ...
  const doSearch = async (overrides?: { email?: string; name?: string }) => {
    setLoading(true)
      ...
      {claims.length > 0 && (
        <div style={{ marginTop: 20 }}>
          ...
          <div className="stat-grid">
            ...
            <div className="stat-card">
              <div className="stat-value">{claims.filter((c) => c.STATUS === "Accepted" || c.STATUS === "Paid").length}</div>
              <div className="stat-label">Accepted / Paid</div>
            </div>
            <div className="stat-card">
              <div className="stat-value">{claims.filter((c) => c.STATUS === "Submitted" || c.STATUS === "Open").length}</div>
