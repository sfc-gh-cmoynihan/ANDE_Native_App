        ...
        headers: [
          {
            ...
            value: "default-src 'self' 'unsafe-inline' 'unsafe-eval'; media-src 'self' https://*.s3.eu-west-1.amazonaws.com https://*.s3.amazonaws.com https://*.snowflakecomputing.com blob: data:; connect-src 'self' https://*.snowflakecomputing.com https://*.s3.eu-west-1.amazonaws.com https://*.s3.amazonaws.com https://*.basemaps.cartocdn.com; img-src 'self' data: blob: https://*.basemaps.cartocdn.com;",
          },
        ],
      },
    ]
